...
<html>
	...
	<body onLoad="cloud9Load();">
	    <div class="navbar navbar-fixed-top">
            <div class="navbar-inner">
                <div class="container">
                    <a class="brand" href="#">Cloud9 PHP</a>
                    <ul class="nav">
                        <li><a href="javascript:loadContent('/ajax/home');">Home</a></li>
                        <li><a href="<?= base_url('editor') ?>">Editor</a></li>
                        <li><a href="javascript:loadContent('/ajax/projects');">Projects</a></li>
                    </ul>
